...
public final class FragmentWeatherBinding implements ViewBinding {
  ...
  private FragmentWeatherBinding(@NonNull LinearLayout rootView, @NonNull RecyclerView recycler) {
  ...
  public static FragmentWeatherBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentWeatherBinding((LinearLayout) rootView, recycler);
    }
