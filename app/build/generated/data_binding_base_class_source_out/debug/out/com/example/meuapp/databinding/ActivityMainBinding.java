...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull LinearLayout rootView, @NonNull FloatingActionButton fab,
      @NonNull TabLayout tabs, @NonNull MaterialToolbar toolbar, @NonNull ViewPager viewpager) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((LinearLayout) rootView, fab, tabs, toolbar, viewpager);
    }
